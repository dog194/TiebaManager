...
TIEBA_API_API CString TiebaClientHTTPPost(const CString& URL, const CString& data, CString* cookie, const int& cliVer)
{
	...
	return HTTPPost(URL, newData, cookie, cliVer);
}
