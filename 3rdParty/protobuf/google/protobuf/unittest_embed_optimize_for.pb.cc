...
TestEmbedOptimizedForSize::TestEmbedOptimizedForSize(const TestEmbedOptimizedForSize& from) : ::google::protobuf::Message() {
...
const ::google::protobuf::Message::ClassData*TestEmbedOptimizedForSize::GetClassData() const { return &_class_data_; }
