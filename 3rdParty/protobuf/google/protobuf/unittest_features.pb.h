...
class TestMessage_Nested final :
 ...
 public:
  ...
  TestMessage_Nested(const TestMessage_Nested& from);
...
class TestMessage final :
 ...
 public:
  ...
  typedef TestMessage_Nested Nested;
...
class TestFeatures_MessageFeature final :
 ...
 public:
  ...
  TestFeatures_MessageFeature(const TestFeatures_MessageFeature& from);
...
class TestFeatures final :
 ...
 public:
  ...
  TestFeatures(const TestFeatures& from);
  ...
  typedef TestFeatures_MessageFeature MessageFeature;
  ...
  void set_allocated_string_source_feature(std::string* ptr);
 ...
 private:
  ...
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<4, 16, 2, 61, 2> _table_;
  template <typename T> friend class ::google::protobuf::Arena::InternalHelper;
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  struct Impl_ {
...
inline std::string* TestFeatures_MessageFeature::mutable_string_field() {
...
inline const ::pb::TestFeatures_MessageFeature& TestFeatures::message_field_feature() const {
...
inline ::pb::TestFeatures_MessageFeature* TestFeatures::_internal_mutable_message_field_feature() {
  ...
  if (_impl_.message_field_feature_ == nullptr) {
    auto* p = CreateMaybeMessage<::pb::TestFeatures_MessageFeature>(GetArenaForAllocation());
    _impl_.message_field_feature_ = reinterpret_cast<::pb::TestFeatures_MessageFeature*>(p);
  }
  return _impl_.message_field_feature_;
}
inline ::pb::TestFeatures_MessageFeature* TestFeatures::mutable_message_field_feature() {
...
inline void TestFeatures::set_allocated_message_field_feature(::pb::TestFeatures_MessageFeature* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::pb::TestFeatures_MessageFeature*>(value));
...
inline PROTOBUF_ALWAYS_INLINE void TestFeatures::set_string_source_feature(Arg_&& arg,
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.string_source_feature_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:pb.TestFeatures.string_source_feature)
}
inline std::string* TestFeatures::mutable_string_source_feature() {
...
inline void TestFeatures::_internal_set_string_source_feature(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.string_source_feature_.Set(value, GetArenaForAllocation());
}
inline std::string* TestFeatures::_internal_mutable_string_source_feature() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.string_source_feature_.Mutable( GetArenaForAllocation());
}
...
inline void TestFeatures::set_allocated_string_source_feature(std::string* value) {
  ...
  _impl_.string_source_feature_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
