...
class TestMessageSetExtension1 final :
 ...
 public:
  ...
  void set_allocated_test_aliasing(std::string* ptr);
 ...
 private:
  ...
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<1, 3, 1, 64, 2> _table_;
  template <typename T> friend class ::google::protobuf::Arena::InternalHelper;
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  struct Impl_ {
...
inline void NestedTestMessageSetContainer::set_allocated_container(::protobuf_unittest::TestMessageSetContainer* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::protobuf_unittest::TestMessageSetContainer*>(value));
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
...
inline void NestedTestMessageSetContainer::set_allocated_child(::protobuf_unittest::NestedTestMessageSetContainer* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::protobuf_unittest::NestedTestMessageSetContainer*>(value));
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000002u;
...
inline void NestedTestInt::set_allocated_child(::protobuf_unittest::NestedTestInt* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::protobuf_unittest::NestedTestInt*>(value));
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
...
inline PROTOBUF_ALWAYS_INLINE void TestMessageSetExtension1::set_test_aliasing(Arg_&& arg,
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.test_aliasing_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void TestMessageSetExtension1::set_allocated_test_aliasing(std::string* value) {
  ...
  _impl_.test_aliasing_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
