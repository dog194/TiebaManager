...
const ::uint32_t TableStruct_google_2fprotobuf_2fcompiler_2fcpp_2ftest_5flarge_5fenum_5fvalue_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
TestLargeEnumValue::TestLargeEnumValue(const TestLargeEnumValue& from) : ::google::protobuf::internal::ZeroFieldsBase() {
...
const ::google::protobuf::Message::ClassData TestLargeEnumValue::_class_data_ = {
    ::google::protobuf::internal::ZeroFieldsBase::CopyImpl,
    ::google::protobuf::internal::ZeroFieldsBase::MergeImpl,
};
const ::google::protobuf::Message::ClassData*TestLargeEnumValue::GetClassData() const { return &_class_data_; }
