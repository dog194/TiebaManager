...
PROTOBUF_CONSTEXPR TestNoPresenceField::TestNoPresenceField(::_pbi::ConstantInitialized)
    : _impl_{
      ...
      /*decltype(_impl_.no_presence_repeated_nested_)*/ {},
      /*decltype(_impl_.no_presence_nested_)*/ nullptr,
      /*decltype(_impl_.no_presence_bool_)*/ false,
    } {}
...
TestNoPresenceField::TestNoPresenceField(const TestNoPresenceField& from) : ::google::protobuf::Message() {
  TestNoPresenceField* const _this = this;
  (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_},
      /*decltype(_impl_._cached_size_)*/ {},
      decltype(_impl_.no_presence_repeated_nested_){from._impl_.no_presence_repeated_nested_},
      decltype(_impl_.no_presence_nested_){nullptr},
      decltype(_impl_.no_presence_bool_){},
  };
  _internal_metadata_.MergeFrom<::google::protobuf::UnknownFieldSet>(
      from._internal_metadata_);
  if ((from._impl_._has_bits_[0] & 0x00000001u) != 0) {
    _this->_impl_.no_presence_nested_ = new ::proto3_unittest::TestNoPresenceField(*from._impl_.no_presence_nested_);
  }
...
inline void TestNoPresenceField::SharedCtor(::_pb::Arena* arena) {
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){},
      /*decltype(_impl_._cached_size_)*/ {},
      decltype(_impl_.no_presence_repeated_nested_){arena},
      decltype(_impl_.no_presence_nested_){nullptr},
      decltype(_impl_.no_presence_bool_){false},
  };
}
...
inline void TestNoPresenceField::SharedDtor() {
  ...
  _impl_.no_presence_repeated_nested_.~RepeatedPtrField();
  if (this != internal_default_instance()) delete _impl_.no_presence_nested_;
}
void TestNoPresenceField::SetCachedSize(int size) const {
...
// @@protoc_insertion_point(message_clear_start:proto3_unittest.TestNoPresenceField)
  ...
  _internal_mutable_no_presence_repeated_nested()->Clear();
...
::uint8_t* TestNoPresenceField::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessage(2, _Internal::no_presence_nested(this),
...
const ::google::protobuf::Message::ClassData*TestNoPresenceField::GetClassData() const { return &_class_data_; }
...
void TestNoPresenceField::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  _this->_internal_mutable_no_presence_repeated_nested()->MergeFrom(from._internal_no_presence_repeated_nested());
  if ((from._impl_._has_bits_[0] & 0x00000001u) != 0) {
...
void TestNoPresenceField::InternalSwap(TestNoPresenceField* other) {
  using std::swap;
