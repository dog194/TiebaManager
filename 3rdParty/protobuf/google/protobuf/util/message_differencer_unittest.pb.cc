...
TestField::TestField(const TestField& from) : ::google::protobuf::Message() {
...
const ::google::protobuf::Message::ClassData*TestField::GetClassData() const { return &_class_data_; }
...
TestDiffMessage_Item::TestDiffMessage_Item(const TestDiffMessage_Item& from) : ::google::protobuf::Message() {
...
inline void TestDiffMessage_Item::SharedCtor(::_pb::Arena* arena) {
  ...
  new (&_impl_) Impl_{
      ...
      /* decltype(_impl_.mp_) */ {::google::protobuf::internal::ArenaInitialized(), arena},
      decltype(_impl_.b_){},
      decltype(_impl_.m_){nullptr},
      decltype(_impl_.a_){0},
  };
...
inline void TestDiffMessage_Item::SharedDtor() {
  ...
  _internal_mutable_rb()->~RepeatedPtrField();
...
const ::_pbi::TcParseTable<3, 7, 3, 52, 2> TestDiffMessage_Item::_table_ = {
  {
    ...
    {::_pbi::TcParser::GetTable<::protobuf_unittest::TestField>()},
    {::_pbi::TcParser::GetTable<::protobuf_unittest::TestField>()},
    {::_pbi::TcParser::GetMapAuxInfo<decltype(TestDiffMessage_Item()._impl_.mp_)>(0, 1, 0)},
  }}, {{
    "\46\0\0\1\2\0\0\2"
    "protobuf_unittest.TestDiffMessage.Item"
    "b"
...
// @@protoc_insertion_point(message_byte_size_start:protobuf_unittest.TestDiffMessage.Item)
  ...
  for (const auto& entry : _internal_mp()) {
    total_size += TestDiffMessage_Item_MpEntry_DoNotUse::Funcs::ByteSizeLong(entry.first, entry.second);
  }
  cached_has_bits = _impl_._has_bits_[0];
...
const ::google::protobuf::Message::ClassData*TestDiffMessage_Item::GetClassData() const { return &_class_data_; }
...
void TestDiffMessage_Item::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  _this->_internal_mutable_rm()->MergeFrom(from._internal_rm());
  _this->_impl_.mp_.MergeFrom(from._impl_.mp_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
...
TestDiffMessage::TestDiffMessage(const TestDiffMessage& from) : ::google::protobuf::Message() {
...
inline void TestDiffMessage::SharedDtor() {
  ...
  _internal_mutable_rw()->~RepeatedPtrField();
...
const ::google::protobuf::Message::ClassData*TestDiffMessage::GetClassData() const { return &_class_data_; }
...
void TestDiffMessage::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  _this->_internal_mutable_rm()->MergeFrom(from._internal_rm());
  _this->_internal_mutable_rany()->MergeFrom(from._internal_rany());
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
