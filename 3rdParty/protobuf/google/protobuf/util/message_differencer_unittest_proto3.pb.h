...
class TestNoPresenceField final :
 ...
 public:
  ...
  TestNoPresenceField(const TestNoPresenceField& from);
...
inline const ::proto3_unittest::TestNoPresenceField& TestNoPresenceField::no_presence_nested() const {
...
inline ::proto3_unittest::TestNoPresenceField* TestNoPresenceField::_internal_mutable_no_presence_nested() {
  ...
  if (_impl_.no_presence_nested_ == nullptr) {
    auto* p = CreateMaybeMessage<::proto3_unittest::TestNoPresenceField>(GetArenaForAllocation());
    _impl_.no_presence_nested_ = reinterpret_cast<::proto3_unittest::TestNoPresenceField*>(p);
  }
  return _impl_.no_presence_nested_;
}
inline ::proto3_unittest::TestNoPresenceField* TestNoPresenceField::mutable_no_presence_nested() {
...
inline void TestNoPresenceField::set_allocated_no_presence_nested(::proto3_unittest::TestNoPresenceField* value) {
  ...
  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::proto3_unittest::TestNoPresenceField*>(value));
...
TestNoPresenceField::mutable_no_presence_repeated_nested() {
...
inline ::proto3_unittest::TestNoPresenceField* TestNoPresenceField::add_no_presence_repeated_nested() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
TestNoPresenceField::no_presence_repeated_nested() const {
