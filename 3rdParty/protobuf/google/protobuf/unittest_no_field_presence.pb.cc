...
const char descriptor_table_protodef_google_2fprotobuf_2funittest_5fno_5ffield_5fpresence_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    "_BAZ\020\002B\005\222\003\002\010\002b\010editionsj\0042023"
};
...
void TestAllTypes::clear_repeated_proto2_message() {
  _internal_mutable_repeated_proto2_message()->Clear();
}
...
void TestAllTypes::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  _this->_internal_mutable_repeated_proto2_message()->MergeFrom(from._internal_repeated_proto2_message());
...
TestProto2Required::TestProto2Required(const TestProto2Required& from) : ::google::protobuf::Message() {
...
const ::google::protobuf::Message::ClassData*TestProto2Required::GetClassData() const { return &_class_data_; }
